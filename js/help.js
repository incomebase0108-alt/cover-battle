...
(function (global) {
  ...
  var HELP_ROWS = [
    ...
    ['爆弾', 'E / 💣（砦・城門の破壊にも使える）'],
    ['武器', 'クラス固定（総大将/足軽/騎馬/忍者/軍師=刀、弓兵=弓、鉄砲兵=鉄砲5連発、槍兵=槍）'],
    ['相性', '三すくみ：槍＞剣 ・ 剣＞弓 ・ 弓＞槍（有利な相手には大ダメージ）'],
    ['クラス特殊', 'C / 🎯（総大将=説得、鉄砲兵=早合、騎馬=突進、忍者=煙幕、軍師=蘇生）'],
    ['軍師の采配', 'V / 🚩（周囲の味方を一時強化。普段も軍師の近くは常時強化＝金の光輪）'],
    ['クラス', '総大将 / 足軽 / 弓兵 / 鉄砲兵 / 騎馬 / 忍者 / 槍兵 / 軍師'],
    ['火薬樽', '撃つと大爆発（敵味方無差別・誘爆あり）。近くで戦うな、敵ごと吹き飛ばせ'],
    ['大将ルール', '総大将がSOS中は回復ゾーン無効＋味方が弱体（救出・蘇生で復帰）'],
